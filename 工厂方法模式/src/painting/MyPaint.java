...
class DrawPanel extends JPanel implements MouseListener, MouseMotionListener {
    ...
    public void mouseDragged(MouseEvent e) {
        if(MyPaint.flag == 0) {
            int x = e.getX();
            int y = e.getY();
            shapes.add(MyPaint.factory.creator(new Point(x - 2, y - 2), new Point(x + 2, y + 2), Color.white));
            repaint();
        }
    }
    ...
    public void mouseReleased(MouseEvent e) {
        ...
        ey = e.getY();
        if (MyPaint.flag == 1) {
            shapes.add(MyPaint.factory.creator(new Point(sx, sy), new Point(ex, ey), Color.black));
            repaint();
        }
    }
